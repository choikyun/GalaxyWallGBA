...
init_sprite_chr (void)
{
  ...
  // タイル　ショット
  CpuSet ( SHOT_TILE, oam + SHIP_TILE_LEN + AIM_TILE_LEN,
          (COPY16 | SHOT_TILE_LEN));
  // タイル　ショット2
  CpuSet ( SHOT2_TILE, oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN,
          (COPY16 | SHOT2_TILE_LEN));
  // タイル　コメット
  CpuSet ( COMET_TILE,
          oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN,
          (COPY16 | COMET_TILE_LEN));
  // タイル　コメット2
  CpuSet (
      COMET2_TILE,
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
          + COMET_TILE_LEN,
      (COPY16 | COMET2_TILE_LEN));
  // タイル　コメット3
  CpuSet (
      COMET3_TILE,
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
          + COMET_TILE_LEN + COMET2_TILE_LEN,
      (COPY16 | COMET3_TILE_LEN));
  // タイル　自機異常1
  CpuSet (
      SHIP_COMET_TILE,
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
          + COMET_TILE_LEN + COMET2_TILE_LEN + COMET3_TILE_LEN,
      (COPY16 | SHIP_COMET_TILE_LEN));
  // タイル　自機異常2
  CpuSet (
      SHIP_COMET2_TILE,
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
          + COMET_TILE_LEN + COMET2_TILE_LEN + COMET3_TILE_LEN
          + SHIP_COMET_TILE_LEN,
      (COPY16 | SHIP_COMET2_TILE_LEN));
  // タイル　自機異常3
  CpuSet (
      SHIP_COMET3_TILE,
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
          + COMET_TILE_LEN + COMET2_TILE_LEN + COMET3_TILE_LEN
          + SHIP_COMET_TILE_LEN + SHIP_COMET2_TILE_LEN,
      (COPY16 | SHIP_COMET3_TILE_LEN));
  ...
  CpuSet (
      ...
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
          + COMET_TILE_LEN + COMET2_TILE_LEN + COMET3_TILE_LEN
          + SHIP_COMET_TILE_LEN + SHIP_COMET2_TILE_LEN + SHIP_COMET3_TILE_LEN,
      (COPY16 | ICON_TILE_LEN));
  // タイル　ストップアイコン
  CpuSet (
      ICON_STOP_TILE,
      oam + SHIP_TILE_LEN + AIM_TILE_LEN + SHOT_TILE_LEN + SHOT2_TILE_LEN
